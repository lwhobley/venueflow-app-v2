...
export default function PilotHealthScreen() {
  ...
  return <ScrollView style={{ flex: 1, backgroundColor: 'transparent' }} contentContainerStyle={{ padding: spacing.lg, gap: spacing.md, paddingBottom: spacing.xxl }}>
    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, alignItems: 'center', justifyContent: 'space-between' }}><View style={{ flex: 1, minWidth: 180 }}><CommandText palette={palette} variant="label">Pilot operations</CommandText><CommandText palette={palette} variant="hero">Pilot Health</CommandText></View><Button mode="text" textColor={palette.primary} onPress={() => router.back()}>Back</Button></View>
