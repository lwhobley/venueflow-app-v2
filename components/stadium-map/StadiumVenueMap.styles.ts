...
export const styles = StyleSheet.create({
  ...
  /* ── Compact Expandable Premium Spaces Directory ── */
  premiumDirectoryContainer: {
    backgroundColor: '#FFFFFF',
    borderBottomWidth: 1,
    borderBottomColor: '#E5E8E2',
  },
  premiumDirectoryHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
    paddingHorizontal: spacing.md,
  ...
  premiumDirectoryTitleRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  },
  premiumDirectoryTitle: {
    fontSize: 12,
    fontWeight: '900',
    color: '#8A5D23',
    letterSpacing: 0.5,
  },
  premiumDirectoryTotalBadge: {
    backgroundColor: '#8A5D23',
    paddingHorizontal: 7,
    paddingVertical: 2,
    borderRadius: 10,
  },
  premiumDirectoryTotalText: {
    color: '#FFFFFF',
    fontSize: 10,
    fontWeight: '800',
  },
  ...
  premiumGroupCountText: {
    fontSize: 11,
    fontWeight: '700',
    color: '#17643B',
  },
  premiumGroupAlertBadge: {
